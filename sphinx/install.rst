...
If :code:`cargo-graph` is available in your opam repository, you can just call::

  opam install cargo-graph

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`cargo-graph` in a directory.
