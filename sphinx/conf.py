...
# -*- coding: utf-8 -*-
#
# cargo-graph documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'cargo-graph.tex', 'cargo-graph Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'cargo-graph', 'cargo-graph Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cargo-graph', 'cargo-graph Documentation',
     author, 'cargo-graph', 'One line description of project.',
     'Miscellaneous'),
]
